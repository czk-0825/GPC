...
def main_field_all():
    ...
    ground_truth = [[0.6,0.05],[1.30,0.115],[1.15,0.05],[1.25,-0.06],[1.25,-0.05],[1.20,0.02],[1.40,0.025],[1.35,0.00]]
    ground_truth = [[0.55,0.05],[1.30,0.115],[1.25,0.05],[1.30,-0.06],[1.25,-0.05],[1.20,0.02],[1.40,0.00],[1.35,0.00]]
    ...
    length_data_mean = np.load('data_all.npy')[0]
    length_data_std = np.load('data_all.npy')[1]
    height_data_mean = np.load('data_all.npy')[2]
    height_data_std = np.load('data_all.npy')[3]
    slope_data_mean = np.load('data_all.npy')[4]
    slope_data_std = np.load('data_all.npy')[5]
